...
public class ModeData : ScriptableObject
{
    ...
    [field: SerializeField] public GameDifficulty difficulty { get; private set; } = GameDifficulty.normal;
    ...
    public void SetData(GameMode mode, GameDifficulty difficulty, string player1Name, string player2Name)
    {
        this.GameMode = mode;
